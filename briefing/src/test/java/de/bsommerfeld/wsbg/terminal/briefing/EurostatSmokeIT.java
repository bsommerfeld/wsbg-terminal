 ...
 *
 * <pre>EUROSTAT_SMOKE=true mvn test -pl briefing -Dtest=EurostatSmokeIT -Dtest.excludedGroups=</pre>
 */
@Tag("integration")
...
class EurostatSmokeIT {
    ...
    void everyCatalogedSeriesCarriesObservations() {
        Map<String, EurostatClient.Reihe> spine = new EurostatClient().spineSeries(24);
