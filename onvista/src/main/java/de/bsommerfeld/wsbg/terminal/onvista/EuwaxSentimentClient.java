...
public class EuwaxSentimentClient extends OnvistaApi {
    ...
    /** Test/default: plain direct transport - onvista's quote path carries no wall. */
    public EuwaxSentimentClient() {
        this(new DirectWebFetcher());
    }

    @Inject
    public EuwaxSentimentClient(@DirectFirst WebFetcher fetcher) {
        super(fetcher);
    }
