...
/**
 * The shared HTML/date/number seam of the boerse.de sources - the handful of
 * primitives the news client (and a later market/dates client) needs, kept in
 * one place so a markup or format quirk is fixed once (probed live 2026-08-02).
 *
