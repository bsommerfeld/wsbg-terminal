 ...
 * under the same id.
 *
 * <pre>EUWAX_SMOKE=true mvn test -pl web/impl -Dtest=EuwaxSentimentSmokeIT -Dtest.excludedGroups=</pre>
 */
@Tag("integration")
...
class EuwaxSentimentSmokeIT {
    ...
    void theRetailGaugeQuotes() {
        EuwaxSentimentClient.Stimmung s = new EuwaxSentimentClient(
                new HouseFetcher(Set.of(new DirectTransport()))).stimmung();
