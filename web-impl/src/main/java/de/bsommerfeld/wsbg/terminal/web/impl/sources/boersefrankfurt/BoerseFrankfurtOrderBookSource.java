 ...
 * delivers complete bodies, and an SSE stream has none), so this client is a DIRECT-ONLY carve-out from the
 * house-seam principle: a dedicated JDK {@link HttpClient} streams lines,
 ...
 */
@Singleton
public class BoerseFrankfurtOrderBookSource implements OrderBookSource {

    private static final Logger LOG = LoggerFactory.getLogger(BoerseFrankfurtOrderBookSource.class);
    ...
    @Inject
    public BoerseFrankfurtOrderBookSource() {
    }
