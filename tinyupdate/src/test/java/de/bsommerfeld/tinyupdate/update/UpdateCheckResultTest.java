...
class UpdateCheckResultTest {
    ...
    void isUpToDate_shouldReturnFalseWithOutdated() {
        var result = new UpdateCheckResult(
                List.of(new de.bsommerfeld.tinyupdate.model.FileEntry("a", "h", 1)),
                List.of());
    ...
    void totalChanges_shouldSumBothLists() {
        var result = new UpdateCheckResult(
                List.of(
                        new de.bsommerfeld.tinyupdate.model.FileEntry("a", "h", 1),
                        new de.bsommerfeld.tinyupdate.model.FileEntry("b", "h", 2)),
