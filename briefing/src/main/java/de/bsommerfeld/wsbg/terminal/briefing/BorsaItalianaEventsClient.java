...
public class BorsaItalianaEventsClient {
    ...
    public BorsaItalianaEventsClient() {
        this(new DirectWebFetcher());
    }

    /** Production: the shared {@code @DirectFirst} seam. */
    @Inject
    public BorsaItalianaEventsClient(@de.bsommerfeld.wsbg.terminal.source.net.DirectFirst WebFetcher fetcher) {
    ...
    private List<EuEvent> fetchFragment(String base, LocalDate from, LocalDate to, int size) {
        ...
        try {
            WebResponse resp = fetcher.fetch(url,
                    java.util.Map.of("User-Agent", userAgent,
