 ...
 * {@code NYSE_SMOKE=true mvn test -pl nyse -Dtest=NyseQuoteClientLiveIT
...
class NyseQuoteClientLiveIT {
    ...
    void appleAnswersWithQuoteAndYearsOfBars() {
        NyseTape t = new NyseQuoteClient().tape("AAPL").orElseThrow();
    ...
    void aTrueNyseListingAnswersToo() {
        NyseTape t = new NyseQuoteClient().tape("KO").orElseThrow();
