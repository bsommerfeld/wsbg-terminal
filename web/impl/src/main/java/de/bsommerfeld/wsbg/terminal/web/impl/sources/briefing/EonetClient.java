 ...
 *
 * <p>Wildfires are dropped on purpose: {@code WildfireClient} already draws
...
public class EonetClient {
    ...
    /** {@code WildfireClient} owns fire, at a resolution this register cannot match. */
    ...
    @Inject
    public EonetClient(WebFetcher fetcher) {
