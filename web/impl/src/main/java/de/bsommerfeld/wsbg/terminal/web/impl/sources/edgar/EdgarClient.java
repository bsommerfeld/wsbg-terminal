 ...
 * below that, but the ceiling is the contract). The UA is therefore set
 * EXPLICITLY at every call site — never left to the transport's default.
 *
...
public class EdgarClient {
    ...
    /** Direct-first transport order (the old {@code @DirectFirst} seam). */
    static final FetchUtil[] MODE = {FetchUtil.DIRECT, FetchUtil.BROWSER};
    ...
    @Inject
    public EdgarClient(WebFetcher fetcher) {
