 ...
 * carries a real TLS fingerprint + cookies and clears bot-walls) while keeping a
 * plain-HTTP fallback, all by wiring rather than by code.
 *
...
public interface WebFetcher {
     ...
     *                browser-backed transport ignores fingerprint-controlled
     *                headers (it sets its own {@code User-Agent} etc.); a direct
     *                transport applies them verbatim. May be empty, never null.
