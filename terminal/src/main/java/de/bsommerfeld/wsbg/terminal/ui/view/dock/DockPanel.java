...
public class DockPanel extends Pane {
    ...
    public DockPanel() {
        this.setStyle("-fx-background-color: #171717;");
    ...
    public void addWidget(DockWidget window) {
    ...
    public void removeWidget(DockWidget window) {
    ...
    public void importLayout(String json) {
        ...
        try {
            ...
            new java.util.ArrayList<>(windows).forEach(this::removeWidget);
