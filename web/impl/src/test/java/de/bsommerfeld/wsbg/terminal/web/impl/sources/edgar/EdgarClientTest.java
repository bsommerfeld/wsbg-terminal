...
import de.bsommerfeld.wsbg.terminal.web.impl.sources.edgar.EdgarClient.EdgarEvent;
...
/** Ported 1:1 from the module world; the fake fetcher speaks the new seam. */
class EdgarClientTest {
    ...
    void nonUsShapesReturnEmptyWithoutNetwork() {
        EdgarClient client = new EdgarClient(new WebFetcher() {
            @Override
