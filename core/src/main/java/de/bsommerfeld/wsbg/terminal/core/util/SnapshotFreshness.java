 ...
 * across any restart — the wire's session state is built up over the whole
 * day, so it must be holdable for a day ("alles was nicht von heute ist,
 * weg"). The TTL stays as the cross-midnight grace (a quick restart
