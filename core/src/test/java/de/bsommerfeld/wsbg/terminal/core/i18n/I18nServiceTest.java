...
class I18nServiceTest {
    ...
    @Test
    void get_shouldReturnWidgetTitles() {
        String tickerChartTitle = service.get("widget.ticker_chart.title");
        assertNotNull(tickerChartTitle);
        assertFalse(tickerChartTitle.isBlank());
        
        String redditTitle = service.get("widget.reddit.title");
        assertNotNull(redditTitle);
        assertFalse(redditTitle.isBlank());
    }
