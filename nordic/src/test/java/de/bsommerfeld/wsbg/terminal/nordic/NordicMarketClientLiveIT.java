 ...
 * {@code NORDIC_SMOKE=true mvn test -pl nordic -Dtest=NordicMarketClientLiveIT
...
class NordicMarketClientLiveIT {
    ...
    void volvoAnswersWithAQuoteInItsHomeCurrency() {
        NordicQuote q = new NordicMarketClient()
                .quoteByIsin("SE0000115446").orElseThrow();
    ...
    void volvoAnswersWithYearsOfBars() {
        NordicHistory h = new NordicMarketClient()
