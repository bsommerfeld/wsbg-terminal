 ...
 * largest-first.
 */
class BundesanzeigerShortInterestSourceTest {

    private final BundesanzeigerShortInterestSource client = new BundesanzeigerShortInterestSource();
    ...
    void parsesGermanNumbers() {
        assertEquals(0.6, BundesanzeigerShortInterestSource.parseGermanNumber("0,60"), 1e-9);
        assertEquals(1.06, BundesanzeigerShortInterestSource.parseGermanNumber("1,06"), 1e-9);
        assertEquals(Double.NaN, BundesanzeigerShortInterestSource.parseGermanNumber(""));
        assertEquals(Double.NaN, BundesanzeigerShortInterestSource.parseGermanNumber(null));
        assertEquals(Double.NaN, BundesanzeigerShortInterestSource.parseGermanNumber("n/a"));
    }
}
