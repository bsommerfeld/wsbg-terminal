package de.bsommerfeld.wsbg.terminal.web.impl.sources.tradegate;
 ...
 */
@Singleton
public class TradegateQuoteSource implements VenueStatsSource {

    private static final Logger LOG = LoggerFactory.getLogger(TradegateQuoteSource.class);
    ...
    /** Direct-first (old {@code @DirectFirst} binding): the plain path answers; the joker rescues walls. */
    ...
    @Inject
    public TradegateQuoteSource(WebFetcher fetcher) {
